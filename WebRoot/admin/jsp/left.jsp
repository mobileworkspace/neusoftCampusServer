    ...
    <td width="182" valign="top"><div id="container">
      ...
      <div class="content">
        ...
        <ul class="MM">
          ...
          <li><a href="article_showlist.action" target="main">有图文章</a></li>
        </ul>
      </div>
      ...
      <h1 class="type"><a href="javascript:void(0)">文章图片</a></h1>
      <div class="content">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><img src="<%=basePath %>admin/images/menu_topline.gif" width="182" height="5" /></td>
        ...
        <ul class="MM">
          <li><a href="article_showlist.action" target="main">全部图文</a></li>
          <li><a href="article_showlistCid.action?categoryid=1" target="main">综合新闻</a></li>
		  <li><a href="article_showlistCid.action?categoryid=2" target="main">图片联播</a></li>
          <li><a href="article_showlistCid.action?categoryid=3" target="main">校园服务</a></li>
		  <li><a href="article_showlistCid.action?categoryid=4" target="main">奖  学  金</a></li>
		  <li><a href="article_showlistCid.action?categoryid=5" target="main">就业服务</a></li>
		  <li><a href="article_showlistCid.action?categoryid=6" target="main">媒体聚焦</a></li>
		  <li><a href="article_showlistCid.action?categoryid=7" target="main">科研团队</a></li>
		  <li><a href="article_showlistCid.action?categoryid=8" target="main">职位空缺</a></li>
          <li><a href="article_showlistCid.action?categoryid=9" target="main">校企合作</a></li>
          <li><a href="article_showlistCid.action?categoryid=10" target="main">科研成果</a></li>
		  <li><a href="article_showlistCid.action?categoryid=11" target="main">集团快讯</a></li>
		  <li><a href="article_showlistCid.action?categoryid=12" target="main">专业介绍</a></li>
        </ul>
      </div>
